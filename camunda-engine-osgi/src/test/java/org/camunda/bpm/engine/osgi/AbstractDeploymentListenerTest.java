...
import org.camunda.bpm.engine.osgi.blueprint.ConfigurationFactory;
import org.camunda.bpm.engine.osgi.blueprint.ProcessEngineFactory;
...
public abstract class AbstractDeploymentListenerTest extends OSGiTestCase {
	...
	private void createProcessEngine() {
		...
		processEngineFactory
				.setBundle(getBundle("org.camunda.bpm.engine.osgi"));
		try {
